...
코드를 안 보는 바이브 코딩에는 한계가 확실했습니다. 체계가 필요했습니다.
...
하지만 느낌대로만 하면 안 됩니다. 그 느낌을 어떻게 구체화해서 에이전트에게 전달하는지가 중요합니다. 코드 작성에서 개발자의 역할이 이동하는 것뿐일 겁니다.

---

## 6단계: 새로운 재미, 그리고 당연함

메타인지를 거치고 1-2개월이 지난 지금, 완전히 다른 감각이 됐습니다.
...
그리고 이 단계를 지나면 결국 **당연**해집니다. 메모장에서 IDE 자동완성으로 넘어갔을 때처럼요. 처음에는 신기하고, 익숙해지면 당연해지고, 나중에는 그냥 도구로 씁니다.
...
당연해진 이후, 불편한 걸 발견하면 자동화하는 게 패턴이 되었습니다. 예전에는 "이거 귀찮네" 하고 넘어갔던 것들을, 지금은 "AI한테 시키면 되겠네" 하고 실제로 만듭니다.
